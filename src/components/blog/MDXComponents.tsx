...
export function ProjectDemo({ title, description, href, tech }: ProjectDemoProps) {
    return (
...
export const mdxComponents = {
    ...
    p: (props: React.HTMLAttributes<HTMLParagraphElement>) => (
        <p className="text-[hsl(var(--foreground)/0.8)] leading-[1.8] my-5" {...props} />
    ),
    ul: (props: React.HTMLAttributes<HTMLUListElement>) => (
        <ul className="list-disc pl-6 my-5 space-y-1.5 text-[hsl(var(--foreground)/0.8)]" {...props} />
    ),
    ol: (props: React.HTMLAttributes<HTMLOListElement>) => (
        <ol className="list-decimal pl-6 my-5 space-y-1.5 text-[hsl(var(--foreground)/0.8)]" {...props} />
    ),
